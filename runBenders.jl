...
solOpt_tup = (gap = 0.001, gapLim = 0.005, gapSwitch = 0.05, delCut = 20, linPar = (thrsAbs = 0.05, thrsRel = 0.05), quadPar = (startRad = 1e-1, lowRad = 1e-6, shrThrs = 5e-4, extThrs = 5e-4))
...
if method in (:all,:fixAndLim,:onlyFix,:fixAndQtr)
	...
	~, heuCom_obj = @suppress heuristicSolve(optMod_dic[:heu],8760/reso_tup.heu,t_int,opt_obj)
