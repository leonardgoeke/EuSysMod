...
solOpt_tup = (gap = 0.001, gapLim = 0.005, gapSwitch = 0.05, delCut = 20, linPar = (thrsAbs = 0.05, thrsRel = 0.05), quadPar = (startRad = 1e-1, lowRad = 1e-6, extThrs = 5e-4, shrThrs = 5e-4))
