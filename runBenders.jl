...
stabSetup_obj = stabSetup(meth_tup, 0.0, :reduced, 0.01, (upper = 50, inter = :log, sub = 10.0), true) # :none for last argument will skip initialization, other names just used for setting input folder below
