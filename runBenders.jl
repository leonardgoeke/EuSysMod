...
if solve in ("noStab1_highPres", "noStab1_lowPres")
	noStab_tup = (upper = 70, inter = :log, sub = 10.0)
elseif solve in ("noStab2_highPres", "noStab2_lowPres")
...
if solve in ("noStab1_highPres", "noStab2_highPres")
	tolStabQ_arr = [1e-6, 1e-6]
	interStabQ_sym = :lin
else solve in ("noStab1_lowPres", "noStab2_lowPres")
