...
elseif method == 7
	meth_tup = (:lvl => (la = 0.75,),)
elseif method == 8
	meth_tup = (:qtr => (start = 0.5e-2, low = 1e-6,  thr = 5e-4, fac = 2.0),)
elseif method == 9
	meth_tup = (:qtr => (start = 2e-2, low = 1e-6,  thr = 5e-4, fac = 2.0),)
elseif method == 10
	meth_tup = (:qtr => (start = 1e-2, low = 1e-6,  thr = 5e-3, fac = 2.0),)
elseif method == 11
	meth_tup = (:qtr => (start = 1e-2, low = 1e-6,  thr = 1e-3, fac = 2.0),)
elseif method == 12
	meth_tup = (:lvl => (la = 0.125,),)
elseif method == 13
