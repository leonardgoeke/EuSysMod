...
nearOptSetup_obj = nearOptSetup(0.1, 0.05, 0.05, 0.0001, 20, nearOptOpj_tup) # cost threshold to keep solution, lls threshold to keep solution, epsilon for near-optimal, stabilization method, cut deletion
...
while true
	...
	#endregion
	#if benders_obj.nearOpt.cnt != 0 break end
...
# 1) comprehensive function to write storage levels 
# 2) passing arguments on what results to write to benders
